...
# for that round is selected: Rock defeats Scissors, Scissors defeats Paper, and Paper defeats Rock. If both
...
########################################################################
def check_score(opponent_choice, my_choice):
    opponent_material = TO_MATERIAL[opponent_choice]
    my_material = TO_MATERIAL[my_choice]
...
def main():
    ...
    for line in open("input.txt"):
        ...
        score = check_score(opponent_choice, my_choice)
        total_score += score
